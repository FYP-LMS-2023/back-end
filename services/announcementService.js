...
exports.createAnnouncement = async (req, res, next) => {
  ...
  if (!classA.teacherIDs.includes(req.user._id)) {
    return res
      .status(400)
      .send({ message: "You are not authorized to post announcements!" });
  }
...
exports.updateAnnouncement = async (req, res, next) => {
  ...
  if (
    ...
    return res
      .status(400)
      .send({ message: "You are not authorized to update this announcement!" });
  }
...
exports.deleteAnnouncement = async (req, res, next) => {
  ...
  if (
    ...
    return res
      .status(400)
      .send({ message: "You are not authorized to delete this announcement!" });
  }
